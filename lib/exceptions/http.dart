...
class ClimathonHttpException extends HttpException {
  ...
  ClimathonHttpException(Uri uri, this.statusCode, [String? message])
...
class StatusCodeException extends ClimathonHttpException {
